...
export const config = {
  matcher: [
    ...
    '/((?!login|api/auth|api/cron|api/trades/mt4|api/mcp|api/scoring/prompt-data|api/scoring/save|\\.well-known|_next/static|_next/image|favicon|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|css|js)).*)',
  ],
}
